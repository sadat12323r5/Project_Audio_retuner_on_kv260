...
fpga -file C:/Sadat_files/Academics/Current_Term/COMP3601/Project/project_repo/COMP3601_Project_Audio_tuner/kv260_lab3/_ide/bitstream/v2.0.bit
targets -set -nocase -filter {name =~"APU*"}
...
set bp_29_38_fsbl_bp [bpadd -addr &XFsbl_Exit]
con -block -timeout 60
bpremove $bp_29_38_fsbl_bp
targets -set -nocase -filter {name =~ "*A53*#0"}
rst -processor
